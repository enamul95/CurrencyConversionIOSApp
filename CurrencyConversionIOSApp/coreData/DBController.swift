...
class DBController{
    ...
    static func getCurrencyList()-> [CurrencyModel] {
        ...
        let sort = NSSortDescriptor(key: "to", ascending: true)
        ...
        do {
            ...
            for data in result as! [NSManagedObject] {
                ...
                list.append(CurrencyModel(currecyCode: currecyCode , from: from,to:to,currecyRate:currecyRate ))
    ...
    static func getCurrency(currecyCode:String)-> CurrencyModel {
        ...
        fetchRequest.predicate = NSPredicate(format: "to = %@", currecyCode)
